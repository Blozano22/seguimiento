...
function ConnectGmailContent() {
  ...
  useEffect(() => {
    ...
    if (success) setToast({ type: 'success', text: `✅ ${decodeURIComponent(success)} conectado correctamente` });
    if (error)   setToast({ type: 'error',   text: `❌ Error: ${decodeURIComponent(error)}` });
  }, [searchParams]);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 text-sm text-blue-700">
          <strong>¿Cómo funciona?</strong> Haz clic en "Conectar" junto al correo de cada persona. Se abrirá la página de Google — la persona debe iniciar sesión con SU cuenta y hacer clic en "Permitir". Después de eso, el sistema enviará correos FROM ese correo automáticamente.
        </div>
