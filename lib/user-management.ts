...
const SEED_USERS: DynamicUser[] = [
  ...
  { username: 'amendoza',     nombre: 'Aimar Mendoza',                     email: 'mendozaaimar@americana.edu.co',       role: 'Gestor', active: true },
  { username: 'cavendano',    nombre: 'Caroll Avendaño',                   email: 'avendanocaroll@americana.edu.co',     role: 'Gestor', active: true },
  { username: 'nsalas',       nombre: 'Nayerlis Salas',                    email: 'salasnayerlis@americana.edu.co',      role: 'Gestor', active: true },
  ...
  { username: 'admin',        nombre: 'Yule',                              email: 'yuleicygamero@americana.edu.co',      role: 'Super Admin', active: true },
];
